...
public class Personagem {
    ...
    private ArrayList<Especial> especials;
    ...
    public Personagem() {
        ...
        this.especials = new ArrayList<>(especials);
    ...
    if (especialDisponivel()) {
        Especial especial = new Especial(this.posicaoEmX + this.larguraImagem, this.posicaoEmY + (this.alturaImagem / 2));
        especial.carregar();
        this.especials.add(especial);
    }
}

public boolean especialDisponivel() {
    // Verifica se já existe um tiro especial em jogo
    return this.especials.isEmpty();
}
    ...
    public ArrayList<Especial> getEspecials() {
        return this.especials;
    }

    public void setEspecials(ArrayList<Especial> especials) {
